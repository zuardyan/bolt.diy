      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-grower-ai-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-grower-ai-elements-item-backgroundAccent hover:bg-grower-ai-elements-artifacts-backgroundHover"
