      ...
      return {
        div: ({ className, children, node, ...props }) => {
          ...
          if (className?.includes('__boltSelectedElement__')) {
            ...
            return (
              <div className="bg-grower-ai-elements-background-depth-3 border border-grower-ai-elements-borderColor rounded-lg p-3 my-2">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-xs font-mono bg-grower-ai-elements-background-depth-2 px-2 py-1 rounded text-grower-ai-elements-textTer">
                    {elementData?.tagName}
                  </span>
                  {elementData?.className && (
                    <span className="text-xs text-grower-ai-elements-textSecondary">.{elementData.className}</span>
                  )}
                </div>
                <code className="block text-sm !text-grower-ai-elements-textSecondary !bg-grower-ai-elements-background-depth-2 border border-grower-ai-elements-borderColor p-2 rounded">
        ...
        button: ({ node, children, ...props }) => {
          ...
          if (
            ...
            return (
              <button
                className="rounded-md justify-center px-3 py-1.5 text-xs bg-grower-ai-elements-item-backgroundAccent text-grower-ai-elements-item-contentAccent opacity-90 hover:opacity-100 flex items-center gap-2 cursor-pointer"
                data-type={type}
