    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <section aria-labelledby="server-status-heading">
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-base font-medium text-grower-ai-elements-textPrimary">MCP Servers Configured</h2>{' '}
          <button
            onClick={checkServerAvailability}
            disabled={isCheckingServers || !parsedConfig || serverEntries.length === 0}
            className={classNames(
              'px-3 py-1.5 rounded-lg text-sm',
              'bg-grower-ai-elements-background-depth-3 hover:bg-grower-ai-elements-background-depth-4',
          ...
          >
            {isCheckingServers ? (
              <div className="i-svg-spinners:90-ring-with-bg w-3 h-3 text-grower-ai-elements-loader-progress animate-spin" />
            ) : (
      ...
      <section aria-labelledby="config-section-heading">
        <h2 className="text-base font-medium text-grower-ai-elements-textPrimary mb-3">Configuration</h2>

        <div className="space-y-4">
          <div>
            <label htmlFor="mcp-config" className="block text-sm text-grower-ai-elements-textSecondary mb-2">
              Configuration JSON
            </label>
            <textarea
              id="mcp-config"
              ...
              className={classNames(
                ...
                'border',
                error ? 'border-grower-ai-elements-icon-error' : 'border-[#E5E5E5] dark:border-[#333333]',
                'text-grower-ai-elements-textPrimary',
                'focus:outline-none focus:ring-1 focus:ring-grower-ai-elements-focus',
              )}
            />
          </div>
          <div>{error && <p className="mt-2 mb-2 text-sm text-grower-ai-elements-icon-error">{error}</p>}</div>
          <div>
            <label htmlFor="max-llm-steps" className="block text-sm text-grower-ai-elements-textSecondary mb-2">
            ...
            <input
              ...
              className="w-full px-3 py-2 text-grower-ai-elements-textPrimary text-sm rounded-lg bg-white dark:bg-grower-ai-elements-background-depth-4 border border-grower-ai-elements-borderColor dark:border-grower-ai-elements-borderColor-dark focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <div className="mt-2 text-sm text-grower-ai-elements-textSecondary">
            ...
            <a
              ...
              className="text-grower-ai-elements-link hover:underline inline-flex items-center gap-1"
            >
      ...
      <div className="flex flex-wrap justify-between gap-3 mt-6">
        <button
          ...
          className="px-4 py-2 rounded-lg text-sm border border-grower-ai-elements-borderColor
                    bg-grower-ai-elements-background-depth-2 text-grower-ai-elements-textSecondary
        ...
        <div className="flex gap-2">
          <button
            ...
            className={classNames(
              ...
              'bg-grower-ai-elements-item-backgroundAccent text-grower-ai-elements-item-contentAccent',
              'hover:bg-grower-ai-elements-item-backgroundActive',
              'disabled:opacity-50 disabled:cursor-not-allowed',
            )}
          >
