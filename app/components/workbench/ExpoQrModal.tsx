  ...
  return (
    <DialogRoot open={open} onOpenChange={(v) => !v && onClose()}>
      <Dialog
        ...
        onClose={onClose}
      >
        <div className="border !border-grower-ai-elements-borderColor flex flex-col gap-5 justify-center items-center p-6 bg-grower-ai-elements-background-depth-2 rounded-md">
          <div className="i-bolt:expo-brand h-10 w-full invert dark:invert-none"></div>
          <DialogTitle className="text-grower-ai-elements-textTertiary text-lg font-semibold leading-6">
            Preview on your own mobile device
          </DialogTitle>
          <DialogDescription className="bg-grower-ai-elements-background-depth-3 max-w-sm rounded-md p-1 border border-grower-ai-elements-borderColor">
