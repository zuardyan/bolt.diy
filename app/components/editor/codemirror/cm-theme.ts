...
function getEditorTheme(settings: EditorSettings) {
  return EditorView.theme({
    ...
    '.cm-tooltip.cm-readonly-tooltip': {
      padding: '4px',
      whiteSpace: 'nowrap',
      backgroundColor: 'var(--grower-ai-elements-bg-depth-2)',
      borderColor: 'var(--grower-ai-elements-borderColorActive)',
      '& .cm-tooltip-arrow:before': {
        borderTopColor: 'var(--grower-ai-elements-borderColorActive)',
      },
