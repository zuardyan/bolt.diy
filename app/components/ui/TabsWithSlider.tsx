        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-grower-ai-elements-background-depth-2 dark:bg-grower-ai-elements-background-depth-3 text-grower-ai-elements-textPrimary dark:text-grower-ai-elements-textPrimary-dark hover:bg-grower-ai-elements-background-depth-3 dark:hover:bg-grower-ai-elements-background-depth-4 border border-grower-ai-elements-borderColor dark:border-grower-ai-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
