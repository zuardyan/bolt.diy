  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-grower-ai-elements-borderColor bg-grower-ai-elements-background-depth-1 text-grower-ai-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-grower-ai-elements-textSecondary', className)} {...props} />;
  },
);
